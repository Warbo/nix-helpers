...
with {
  ...
  depChk =
    with {
      ...
      brokenDepsNotForced =
        runCommand "checkBrokenDepsNotForced"
  ...
  propCheck = {
    oneLevel =
      runCommand "checkDirectPropagationOfWrappedDeps"
        {
          wrapped = wrap {
    ...
    nested =
      runCommand "checkNestedPropagationOfWrappedDeps"
        {
          wrapped = wrap {
